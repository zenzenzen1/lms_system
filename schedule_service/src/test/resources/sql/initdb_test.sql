...
CREATE TABLE public.semester (
	...
	CONSTRAINT semester_pkey PRIMARY KEY (semester_code)
);
...
CREATE TABLE public.users (
	...
	CONSTRAINT fkfbi6ooctx7u7q747ndkg6fps9 FOREIGN KEY (class_code) REFERENCES public."class"(class_code)
);
...
CREATE TABLE public.course (
	...
	CONSTRAINT fkbhmlx82vjuwypl8dmfnrbjfhu FOREIGN KEY (teacher_id) REFERENCES public.users(id) ON DELETE CASCADE,
	CONSTRAINT fkf9mvo7mmq877hmye26t1blwb4 FOREIGN KEY (subject_code) REFERENCES public.subject(subject_code),
	CONSTRAINT fkjyy9lqlqj4udroainv4ih92pm FOREIGN KEY (semester_code) REFERENCES public.semester(semester_code)
);


-- public.course_student definition
...
CREATE TABLE public.course_student (
	...
	CONSTRAINT fk7735e1tmooufb4suulr267012 FOREIGN KEY (student_id) REFERENCES public.users(id) ON DELETE CASCADE,
	CONSTRAINT fklmj50qx9k98b7li5li74nnylb FOREIGN KEY (course_id) REFERENCES public.course(course_id)
);
...
CREATE TABLE public.schedule (
	...
	CONSTRAINT fk1psrumo7fgkd16p438etda0i6 FOREIGN KEY (course_id) REFERENCES public.course(course_id) ON DELETE CASCADE,
	CONSTRAINT fk5fp0w97s834q3fmitfvbhhfb3 FOREIGN KEY (slot_id) REFERENCES public.slot(slot_id),
	CONSTRAINT fkh2hdhbss2x31ns719hka6enma FOREIGN KEY (room_id) REFERENCES public.room(room_id),
	CONSTRAINT fki2pon95cveg50inl9u9bp5b25 FOREIGN KEY (subject_code) REFERENCES public.subject(subject_code)
);
...
CREATE TABLE public.attendance (
	...
	CONSTRAINT fk3ubfa45l2ve7k80jlxkwh5ht5 FOREIGN KEY (schedule_id) REFERENCES public.schedule(schedule_id),
	CONSTRAINT fk80qpvlsg0xpmw80bnk64avvou FOREIGN KEY (student_id) REFERENCES public.users(id)
);
