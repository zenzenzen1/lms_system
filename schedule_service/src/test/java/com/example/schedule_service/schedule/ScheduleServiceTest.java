...
public class ScheduleServiceTest extends BaseContainerTest{
    ...
    void test_saveSchedule_shouldSuccess() throws IdNotFoundException{
        ...
        // assert courseStudents.size() == studentIds.size() : "Course students size should match the number of students";
        ...
        //     assert studentIds.contains(courseStudent.getStudentId()) : "Student should be in the course";
        //     result.forEach(schedule -> {
        //         var attendance = attendanceRepository.findByStudent_UserIdAndSchedule_ScheduleId(courseStudent.getStudentId(), schedule.getScheduleId());
        //         assert attendance != null : "Attendance should not be null for student " + courseStudent.getStudentId() + " and schedule " + schedule.getScheduleId();
        ...
        // assert attendances.size() == result.size() * studentIds.size() : "Attendance size should match the number of students' schedules";
