...
import com.example.schedule_service.service.AttendanceService;
...
public class AttendanceController {
    ...
    public Object getAttendancesByCourseIdStudentId(
            @RequestParam Long courseId, @RequestParam String studentId) {
        return ResponseEntity.ok(ApiResponse.<Object>builder()
                .httpStatus(HttpStatus.OK)
                .message("Attendance records retrieved successfully")
                .result(attendanceService.getAttendancesByCourseIdStudentId(courseId, studentId))
                .build())
        ;
    }
    ...
    public Object saveAllAttendance(@RequestBody AttendanceRequest attendanceRequests) {
        ...
        log.info("size: {} - {}", attendanceRequests.getAttendanceRequests().size(),
    ...
    public ResponseEntity<ApiResponse<List<AttendanceResponse>>> getStudentsByScheduleId(@PathVariable Long scheduleId) {
        return ResponseEntity.ok(ApiResponse.<List<AttendanceResponse>>builder()
                .httpStatus(HttpStatus.OK)
                .message("Attendance records retrieved successfully")
                .result(attendanceService.getStudentsByScheduleId(scheduleId))
                .build());

    }

    @GetMapping("/teacherId/{teacherId}")
    public Object getScheduleByTeacherId(@PathVariable String teacherId, @RequestParam String startDate,
