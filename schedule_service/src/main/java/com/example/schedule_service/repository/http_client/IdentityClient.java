package com.example.schedule_service.repository.http_client;
...
import com.example.schedule_service.configuration.AuthenticationRequestInterceptor;
...
public interface IdentityClient {
    ...
    Object getUserByRole(@PathVariable String role);
